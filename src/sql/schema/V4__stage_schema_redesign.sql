...
CREATE TABLE stage.tbl_pozo_maestra (
    ...
    longitud_carrera_nominal_unidad DECIMAL, -- ID: 42 nombre actualizado
    ...
    num_software VARCHAR(50), -- ID: 87

    -- Variables Movidas (IDs 72, 75)
...
-- Table tbl_pozo_produccion (Tabla Ancha V4)
CREATE TABLE stage.tbl_pozo_produccion (
    ...
    presion_cabezal DECIMAL, -- ID: 54
    presion_casing DECIMAL, -- ID: 55
    temperatura_cabezal DECIMAL, -- ID: 56
    ...
    -- Cargas y Carreras
    longitud_carrera_nominal DECIMAL, -- ID: 122 (Antes longitud_carrera_nominal_actual_S)
...
CREATE TABLE stage.tbl_pozo_scada_dq (
    ...
    variable_id INT, -- Referencia a Referencial (ID Maestra)
    regla_id INT,    -- Referencia a Referencial (ID Regla)
    ...
    mensaje_error TEXT, -- Agregado para compatibilidad con V5
