...
CREATE TABLE stage.tbl_pozo_produccion (
    ...
    PIP DECIMAL, -- ID: 61
    --temperatura_motor DECIMAL, -- ID: 83
    --temperatura_aceite_tanque DECIMAL, -- ID: 84
    ...
    --porcentaje_amperaje DECIMAL, -- ID: 70
    ...
    --carrera_actual_unidad DECIMAL, -- ID: 68
    --carrera_actual_bomba DECIMAL, -- ID: 69
    ...
    --uso_energia_medidor DECIMAL, -- ID: 117
